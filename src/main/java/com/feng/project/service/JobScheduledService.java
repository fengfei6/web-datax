...
public class JobScheduledService {
    ...
    public void realTimeUpdateInstance() throws UnsupportedEncodingException {
        //获取远程的实例
        List<JSONObject> jobs = xxlJobService.getAllHandleInfo();
        saveIntoInstance(jobs);
    }

    private void saveIntoInstance(List<JSONObject> jobs) throws UnsupportedEncodingException {
